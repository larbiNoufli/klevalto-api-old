...
public class SergicApp {

    private static final Logger log = LoggerFactory.getLogger(SergicApp.class);

    private final Environment env;

    public SergicApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SergicApp.class);
